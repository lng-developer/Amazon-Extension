...
export function parseAmazonProcessingReport(reportText) {
  ...
  return {
    ...
    recordsProcessed: numberAfterLabel(text, "Number of records processed from this upload"),
    recordsActivated: numberAfterLabel(text, "Number of records that were activated"),
...
export function shouldRefreshAmazonFeedHistory(watch = {}) {
  return watch.createdDedicatedTab === true;
}
